    ...
    <nav className="fixed bottom-0 left-0 right-0 z-40 safe-bottom">
      <div className="glass border-t border-border/50">
        <div className="flex items-center justify-around h-16 max-w-lg mx-auto">
          {tabs.map((tab) => {
            ...
            return (
              <button
                ...
                className={cn(
                  "flex flex-col items-center justify-center gap-0.5 h-full px-3 transition-colors relative",
          ...
          <button
            onClick={onAddTask}
            className="flex flex-col items-center justify-center gap-0.5 h-full px-3 text-primary"
          >
